 ...
 <v-form
  ...
  >
    ...
    filled
      ...
      required
    ></v-text-field>
        <p class="signInFooter" v-show="AlreadyExist"> * Invalid email / password </p>
    <v-btn
    ...
    >
      Log in
        ...
        <p class="ml-5">New to Title? <router-link to="/student-signIn">Create an account</router-link></p>
  <br>
    <v-spacer></v-spacer>
        <v-spacer></v-spacer>
