<template>
    ...
    >
      <v-card-text color="indigo darken-2" >
        ...
        School Fees Payment Suggestion    
        </p>
              ...
              <v-row justify="center">
               ...
               <router-link to="/studentviewNoticeBoard"    class="hoverComponent" style="color:white">
               <v-btn
          ...
          color="indigo darken-2"
            >
              Pay with Bank
                ...
                <v-icon class="d-flex justify-content-center" color="indigo darken-2" style="font-size:100px">mdi-cellphone-basic</v-icon><br>
                <router-link to="/pay-now" style="color:white">
